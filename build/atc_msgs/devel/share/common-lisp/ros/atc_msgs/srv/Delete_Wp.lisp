...
(cl:defmethod cl:initialize-instance :after ((m <Delete_Wp-request>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'Delete_Wp-request)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name atc_msgs-srv:<Delete_Wp-request> is deprecated: use atc_msgs-srv:Delete_Wp-request instead.")))
...
(cl:defmethod cl:initialize-instance :after ((m <Delete_Wp-response>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'Delete_Wp-response)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name atc_msgs-srv:<Delete_Wp-response> is deprecated: use atc_msgs-srv:Delete_Wp-response instead.")))
