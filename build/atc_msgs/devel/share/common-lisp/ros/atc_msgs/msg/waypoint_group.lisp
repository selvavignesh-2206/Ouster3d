...
(cl:defmethod cl:initialize-instance :after ((m <waypoint_group>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'waypoint_group)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name atc_msgs-msg:<waypoint_group> is deprecated: use atc_msgs-msg:waypoint_group instead.")))
...
(cl:defmethod wp_list-val ((m <waypoint_group>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader atc_msgs-msg:wp_list-val is deprecated.  Use atc_msgs-msg:wp_list instead.")
  (wp_list m))
