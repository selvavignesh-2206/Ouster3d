...
class AprilTagDetection(genpy.Message):
  _md5sum = "3d65b1a354327ff08aa51847b4a25220"
...
float64 w
"""
  __slots__ = ['id','size','pose','pixelPosRight','pixelPosDown','tagArea']
  _slot_types = ['int32[]','float64[]','geometry_msgs/PoseWithCovarianceStamped','float64','float64','float64']
  ...
  def __init__(self, *args, **kwds):
    ...
    The available fields are:
       id,size,pose,pixelPosRight,pixelPosDown,tagArea
  ...
  def serialize(self, buff):
    ...
    try:
      ...
      _x = self
      buff.write(_get_struct_3d().pack(_x.pixelPosRight, _x.pixelPosDown, _x.tagArea))
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      (_x.pixelPosRight, _x.pixelPosDown, _x.tagArea,) = _get_struct_3d().unpack(str[start:end])
      return self
