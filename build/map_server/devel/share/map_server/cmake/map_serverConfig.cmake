...
if("TRUE" STREQUAL "TRUE")
  set(map_server_SOURCE_PREFIX /home/msi/caato2_ws/src/thirdparty/map_server)
  set(map_server_DEVEL_PREFIX /home/msi/caato2_ws/build/map_server/devel)
  ...
  set(map_server_INSTALL_PREFIX /home/msi/caato2_ws/install/map_server)
...
if(NOT "/home/msi/caato2_ws/src/thirdparty/map_server/include " STREQUAL " ")
  set(map_server_INCLUDE_DIRS "")
  set(_include_dirs "/home/msi/caato2_ws/src/thirdparty/map_server/include")
  if(NOT " " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'map_server' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/msi/caato2_ws/src/thirdparty/map_server/${idir}'.  ${_report}")
    endif()
...
foreach(library ${libraries})
  ...
  elseif(IS_ABSOLUTE ${library})
    ...
    foreach(path /home/msi/caato2_ws/build/map_server/devel/lib;/opt/ros/noetic/lib)
