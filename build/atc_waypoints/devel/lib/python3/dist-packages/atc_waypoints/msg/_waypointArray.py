...
"""autogenerated by genpy from atc_waypoints/waypointArray.msg. Do not edit."""
import codecs
import sys
...
"""
  ...
  _slot_types = ['string','atc_waypoints/waypoint_msg[]','atc_waypoints/waypoint_group[]']
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      for i in range(0, length):
        val1 = atc_waypoints.msg.waypoint_msg()
        start = end
        end += 4
        (length,) = _struct_I.unpack(str[start:end])
        start = end
      ...
      self.groups = []
      for i in range(0, length):
        val1 = atc_waypoints.msg.waypoint_group()
        start = end
        end += 4
        (length,) = _struct_I.unpack(str[start:end])
        start = end
