...
(cl:defmethod cl:initialize-instance :after ((m <Stop_Wp-request>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'Stop_Wp-request)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name atc_waypoints-srv:<Stop_Wp-request> is deprecated: use atc_waypoints-srv:Stop_Wp-request instead.")))
...
(cl:defmethod cl:initialize-instance :after ((m <Stop_Wp-response>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'Stop_Wp-response)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name atc_waypoints-srv:<Stop_Wp-response> is deprecated: use atc_waypoints-srv:Stop_Wp-response instead.")))
