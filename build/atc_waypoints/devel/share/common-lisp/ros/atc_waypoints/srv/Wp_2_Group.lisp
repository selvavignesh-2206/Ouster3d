...
(cl:defmethod cl:initialize-instance :after ((m <Wp_2_Group-request>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'Wp_2_Group-request)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name atc_waypoints-srv:<Wp_2_Group-request> is deprecated: use atc_waypoints-srv:Wp_2_Group-request instead.")))

(cl:ensure-generic-function 'option-val :lambda-list '(m))
(cl:defmethod option-val ((m <Wp_2_Group-request>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader atc_waypoints-srv:option-val is deprecated.  Use atc_waypoints-srv:option instead.")
  (option m))

(cl:ensure-generic-function 'group_name-val :lambda-list '(m))
(cl:defmethod group_name-val ((m <Wp_2_Group-request>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader atc_waypoints-srv:group_name-val is deprecated.  Use atc_waypoints-srv:group_name instead.")
  (group_name m))

(cl:ensure-generic-function 'wp_name-val :lambda-list '(m))
(cl:defmethod wp_name-val ((m <Wp_2_Group-request>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader atc_waypoints-srv:wp_name-val is deprecated.  Use atc_waypoints-srv:wp_name instead.")
  (wp_name m))

(cl:ensure-generic-function 'pos-val :lambda-list '(m))
(cl:defmethod pos-val ((m <Wp_2_Group-request>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader atc_waypoints-srv:pos-val is deprecated.  Use atc_waypoints-srv:pos instead.")
  (pos m))
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql '<Wp_2_Group-request>)))
  ...
  "atc_waypoints/Wp_2_GroupRequest")
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'Wp_2_Group-request)))
  "Returns string type for a service object of type 'Wp_2_Group-request"
  "atc_waypoints/Wp_2_GroupRequest")
...
(cl:defmethod cl:initialize-instance :after ((m <Wp_2_Group-response>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'Wp_2_Group-response)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name atc_waypoints-srv:<Wp_2_Group-response> is deprecated: use atc_waypoints-srv:Wp_2_Group-response instead.")))

(cl:ensure-generic-function 'success-val :lambda-list '(m))
(cl:defmethod success-val ((m <Wp_2_Group-response>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader atc_waypoints-srv:success-val is deprecated.  Use atc_waypoints-srv:success instead.")
  (success m))
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql '<Wp_2_Group-response>)))
  ...
  "atc_waypoints/Wp_2_GroupResponse")
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'Wp_2_Group-response)))
  "Returns string type for a service object of type 'Wp_2_Group-response"
  "atc_waypoints/Wp_2_GroupResponse")
