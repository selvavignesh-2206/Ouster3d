...
(cl:defmethod cl:initialize-instance :after ((m <waypoint_msg>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'waypoint_msg)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name atc_waypoints-msg:<waypoint_msg> is deprecated: use atc_waypoints-msg:waypoint_msg instead.")))
...
(cl:defmethod pose-val ((m <waypoint_msg>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader atc_waypoints-msg:pose-val is deprecated.  Use atc_waypoints-msg:pose instead.")
  (pose m))
