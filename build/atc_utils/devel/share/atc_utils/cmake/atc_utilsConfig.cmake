...
if(NOT "/home/msi/caato2_ws/src/siot/atc_meta_package/atc_utils/include " STREQUAL " ")
  set(atc_utils_INCLUDE_DIRS "")
  set(_include_dirs "/home/msi/caato2_ws/src/siot/atc_meta_package/atc_utils/include")
  if(NOT " " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'atc_utils' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/msi/caato2_ws/src/siot/atc_meta_package/atc_utils/${idir}'.  ${_report}")
    endif()
...
foreach(library ${libraries})
  ...
  elseif(IS_ABSOLUTE ${library})
    ...
    foreach(path /home/msi/caato2_ws/build/atc_utils/devel/lib;/opt/ros/noetic/lib)
