...
namespace jsk_gui_msgs
{
  ...
  class Action : public ros::Msg
  {
    ...
    virtual int deserialize(unsigned char *inbuffer) override
    {
      ...
      u_state_value.base |= ((uint32_t) (*(inbuffer + offset + 0))) << (8 * 0);
      u_state_value.base |= ((uint32_t) (*(inbuffer + offset + 1))) << (8 * 1);
      u_state_value.base |= ((uint32_t) (*(inbuffer + offset + 2))) << (8 * 2);
      u_state_value.base |= ((uint32_t) (*(inbuffer + offset + 3))) << (8 * 3);
      ...
      u_direction_value.base |= ((uint32_t) (*(inbuffer + offset + 0))) << (8 * 0);
      u_direction_value.base |= ((uint32_t) (*(inbuffer + offset + 1))) << (8 * 1);
      u_direction_value.base |= ((uint32_t) (*(inbuffer + offset + 2))) << (8 * 2);
      u_direction_value.base |= ((uint32_t) (*(inbuffer + offset + 3))) << (8 * 3);
