...
namespace jsk_recognition_msgs
{
  ...
  class DepthCalibrationParameter : public ros::Msg
  {
    ...
    virtual int deserialize(unsigned char *inbuffer) override
    {
      ...
      u_st_coefficients2.base |= ((uint32_t) (*(inbuffer + offset + 0))) << (8 * 0);
      u_st_coefficients2.base |= ((uint32_t) (*(inbuffer + offset + 1))) << (8 * 1);
      u_st_coefficients2.base |= ((uint32_t) (*(inbuffer + offset + 2))) << (8 * 2);
      u_st_coefficients2.base |= ((uint32_t) (*(inbuffer + offset + 3))) << (8 * 3);
      ...
      u_st_coefficients1.base |= ((uint32_t) (*(inbuffer + offset + 0))) << (8 * 0);
      u_st_coefficients1.base |= ((uint32_t) (*(inbuffer + offset + 1))) << (8 * 1);
      u_st_coefficients1.base |= ((uint32_t) (*(inbuffer + offset + 2))) << (8 * 2);
      u_st_coefficients1.base |= ((uint32_t) (*(inbuffer + offset + 3))) << (8 * 3);
      ...
      u_st_coefficients0.base |= ((uint32_t) (*(inbuffer + offset + 0))) << (8 * 0);
      u_st_coefficients0.base |= ((uint32_t) (*(inbuffer + offset + 1))) << (8 * 1);
      u_st_coefficients0.base |= ((uint32_t) (*(inbuffer + offset + 2))) << (8 * 2);
      u_st_coefficients0.base |= ((uint32_t) (*(inbuffer + offset + 3))) << (8 * 3);
