...
#include "rosserial/geometry_msgs/PolygonStamped.h"
#include "rosserial/geometry_msgs/PointStamped.h"
#include "rosserial/geometry_msgs/Vector3Stamped.h"
...
namespace jsk_recognition_msgs
{
  ...
  class SnapItRequest : public ros::Msg
  {
    ...
    virtual int deserialize(unsigned char *inbuffer) override
    {
      ...
      u_eps_angle.base = 0;
      u_eps_angle.base |= ((uint32_t) (*(inbuffer + offset + 0))) << (8 * 0);
      u_eps_angle.base |= ((uint32_t) (*(inbuffer + offset + 1))) << (8 * 1);
      u_eps_angle.base |= ((uint32_t) (*(inbuffer + offset + 2))) << (8 * 2);
      u_eps_angle.base |= ((uint32_t) (*(inbuffer + offset + 3))) << (8 * 3);
