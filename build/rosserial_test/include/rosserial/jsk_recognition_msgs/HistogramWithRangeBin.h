...
namespace jsk_recognition_msgs
{
  ...
  class HistogramWithRangeBin : public ros::Msg
  {
    ...
    virtual int deserialize(unsigned char *inbuffer) override
    {
      ...
      u_min_value.base = 0;
      u_min_value.base |= ((uint32_t) (*(inbuffer + offset + 0))) << (8 * 0);
      u_min_value.base |= ((uint32_t) (*(inbuffer + offset + 1))) << (8 * 1);
      u_min_value.base |= ((uint32_t) (*(inbuffer + offset + 2))) << (8 * 2);
      u_min_value.base |= ((uint32_t) (*(inbuffer + offset + 3))) << (8 * 3);
      ...
      u_max_value.base = 0;
      u_max_value.base |= ((uint32_t) (*(inbuffer + offset + 0))) << (8 * 0);
      u_max_value.base |= ((uint32_t) (*(inbuffer + offset + 1))) << (8 * 1);
      u_max_value.base |= ((uint32_t) (*(inbuffer + offset + 2))) << (8 * 2);
      u_max_value.base |= ((uint32_t) (*(inbuffer + offset + 3))) << (8 * 3);
