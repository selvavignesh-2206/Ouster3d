...
namespace pr2_msgs
{
  ...
  class PowerBoardState : public ros::Msg
  {
    ...
    virtual int deserialize(unsigned char *inbuffer) override
    {
      ...
      u_circuit_voltagei.base |= ((uint32_t) (*(inbuffer + offset + 0))) << (8 * 0);
      u_circuit_voltagei.base |= ((uint32_t) (*(inbuffer + offset + 1))) << (8 * 1);
      u_circuit_voltagei.base |= ((uint32_t) (*(inbuffer + offset + 2))) << (8 * 2);
      u_circuit_voltagei.base |= ((uint32_t) (*(inbuffer + offset + 3))) << (8 * 3);
