...
#include "rosserial/moveit_msgs/MotionPlanRequest.h"
...
namespace moveit_msgs
{
  ...
  class MotionSequenceItem : public ros::Msg
  {
    ...
    virtual int deserialize(unsigned char *inbuffer) override
    {
      ...
      u_blend_radius.base |= ((uint32_t) (*(inbuffer + offset + 0))) << (8 * 0);
      u_blend_radius.base |= ((uint32_t) (*(inbuffer + offset + 1))) << (8 * 1);
      u_blend_radius.base |= ((uint32_t) (*(inbuffer + offset + 2))) << (8 * 2);
      u_blend_radius.base |= ((uint32_t) (*(inbuffer + offset + 3))) << (8 * 3);
