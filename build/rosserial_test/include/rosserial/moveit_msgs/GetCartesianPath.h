...
#include "rosserial/moveit_msgs/MoveItErrorCodes.h"
#include "rosserial/moveit_msgs/Constraints.h"
#include "rosserial/moveit_msgs/RobotTrajectory.h"
#include "rosserial/moveit_msgs/RobotState.h"
...
static const char GETCARTESIANPATH[] = "moveit_msgs/GetCartesianPath";
  ...
  class GetCartesianPathRequest : public ros::Msg
  {
    ...
    virtual int deserialize(unsigned char *inbuffer) override
    {
      ...
      u_prismatic_jump_threshold.base |= ((uint32_t) (*(inbuffer + offset + 0))) << (8 * 0);
      u_prismatic_jump_threshold.base |= ((uint32_t) (*(inbuffer + offset + 1))) << (8 * 1);
      u_prismatic_jump_threshold.base |= ((uint32_t) (*(inbuffer + offset + 2))) << (8 * 2);
      u_prismatic_jump_threshold.base |= ((uint32_t) (*(inbuffer + offset + 3))) << (8 * 3);
      ...
      u_revolute_jump_threshold.base |= ((uint32_t) (*(inbuffer + offset + 0))) << (8 * 0);
      u_revolute_jump_threshold.base |= ((uint32_t) (*(inbuffer + offset + 1))) << (8 * 1);
      u_revolute_jump_threshold.base |= ((uint32_t) (*(inbuffer + offset + 2))) << (8 * 2);
      u_revolute_jump_threshold.base |= ((uint32_t) (*(inbuffer + offset + 3))) << (8 * 3);
