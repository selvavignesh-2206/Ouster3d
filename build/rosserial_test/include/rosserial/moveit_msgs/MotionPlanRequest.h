...
#include "rosserial/moveit_msgs/WorkspaceParameters.h"
#include "rosserial/moveit_msgs/RobotState.h"
#include "rosserial/moveit_msgs/Constraints.h"
#include "rosserial/moveit_msgs/TrajectoryConstraints.h"
#include "rosserial/moveit_msgs/GenericTrajectory.h"
...
namespace moveit_msgs
{
  ...
  class MotionPlanRequest : public ros::Msg
  {
    ...
    virtual int deserialize(unsigned char *inbuffer) override
    {
      ...
      u_max_cartesian_speed.base |= ((uint32_t) (*(inbuffer + offset + 0))) << (8 * 0);
      u_max_cartesian_speed.base |= ((uint32_t) (*(inbuffer + offset + 1))) << (8 * 1);
      u_max_cartesian_speed.base |= ((uint32_t) (*(inbuffer + offset + 2))) << (8 * 2);
      u_max_cartesian_speed.base |= ((uint32_t) (*(inbuffer + offset + 3))) << (8 * 3);
