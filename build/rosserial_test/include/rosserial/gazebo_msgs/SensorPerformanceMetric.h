...
namespace gazebo_msgs
{
  ...
  class SensorPerformanceMetric : public ros::Msg
  {
    ...
    virtual int deserialize(unsigned char *inbuffer) override
    {
      ...
      u_sim_update_rate.base |= ((uint32_t) (*(inbuffer + offset + 0))) << (8 * 0);
      u_sim_update_rate.base |= ((uint32_t) (*(inbuffer + offset + 1))) << (8 * 1);
      u_sim_update_rate.base |= ((uint32_t) (*(inbuffer + offset + 2))) << (8 * 2);
      u_sim_update_rate.base |= ((uint32_t) (*(inbuffer + offset + 3))) << (8 * 3);
      ...
      u_real_update_rate.base |= ((uint32_t) (*(inbuffer + offset + 0))) << (8 * 0);
      u_real_update_rate.base |= ((uint32_t) (*(inbuffer + offset + 1))) << (8 * 1);
      u_real_update_rate.base |= ((uint32_t) (*(inbuffer + offset + 2))) << (8 * 2);
      u_real_update_rate.base |= ((uint32_t) (*(inbuffer + offset + 3))) << (8 * 3);
