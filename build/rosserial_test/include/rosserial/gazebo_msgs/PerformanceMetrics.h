...
#include "rosserial/gazebo_msgs/SensorPerformanceMetric.h"
...
namespace gazebo_msgs
{
  ...
  class PerformanceMetrics : public ros::Msg
  {
    ...
    virtual int deserialize(unsigned char *inbuffer) override
    {
      ...
      u_real_time_factor.base |= ((uint32_t) (*(inbuffer + offset + 0))) << (8 * 0);
      u_real_time_factor.base |= ((uint32_t) (*(inbuffer + offset + 1))) << (8 * 1);
      u_real_time_factor.base |= ((uint32_t) (*(inbuffer + offset + 2))) << (8 * 2);
      u_real_time_factor.base |= ((uint32_t) (*(inbuffer + offset + 3))) << (8 * 3);
