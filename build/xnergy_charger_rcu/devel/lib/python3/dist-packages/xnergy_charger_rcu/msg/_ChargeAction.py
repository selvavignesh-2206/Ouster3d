...
"""autogenerated by genpy from xnergy_charger_rcu/ChargeAction.msg. Do not edit."""
import codecs
import sys
...
class ChargeAction(genpy.Message):
  _md5sum = "67a294d98a0f072640646c208ca4cf35"
  _type = "xnergy_charger_rcu/ChargeAction"
...
string message"""
  ...
  _slot_types = ['xnergy_charger_rcu/ChargeActionGoal','xnergy_charger_rcu/ChargeActionResult','xnergy_charger_rcu/ChargeActionFeedback']
  ...
  def __init__(self, *args, **kwds):
    ...
    if args or kwds:
      ...
      if self.action_goal is None:
        self.action_goal = xnergy_charger_rcu.msg.ChargeActionGoal()
      if self.action_result is None:
        self.action_result = xnergy_charger_rcu.msg.ChargeActionResult()
      if self.action_feedback is None:
        self.action_feedback = xnergy_charger_rcu.msg.ChargeActionFeedback()
    else:
      self.action_goal = xnergy_charger_rcu.msg.ChargeActionGoal()
      self.action_result = xnergy_charger_rcu.msg.ChargeActionResult()
      self.action_feedback = xnergy_charger_rcu.msg.ChargeActionFeedback()
  ...
  def serialize(self, buff):
    ...
    try:
      ...
      buff.write(struct.Struct('<I%ss'%length).pack(length, _x))
      _x = self
      buff.write(_get_struct_B3I().pack(_x.action_goal.goal.enable_charge, _x.action_result.header.seq, _x.action_result.header.stamp.secs, _x.action_result.header.stamp.nsecs))
      ...
      _x = self.action_feedback.feedback.status.message
      length = len(_x)
      if python3 or type(_x) == unicode:
        _x = _x.encode('utf-8')
        length = len(_x)
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      (_x.action_goal.goal.enable_charge, _x.action_result.header.seq, _x.action_result.header.stamp.secs, _x.action_result.header.stamp.nsecs,) = _get_struct_B3I().unpack(str[start:end])
      self.action_goal.goal.enable_charge = bool(self.action_goal.goal.enable_charge)
      start = end
      end += 4
      (length,) = _struct_I.unpack(str[start:end])
      start = end
      ...
      (self.action_feedback.feedback.status.state,) = _get_struct_h().unpack(str[start:end])
      start = end
      end += 4
      (length,) = _struct_I.unpack(str[start:end])
      start = end
      ...
      if python3:
        self.action_feedback.feedback.status.message = str[start:end].decode('utf-8', 'rosmsg')
      else:
        self.action_feedback.feedback.status.message = str[start:end]
      return self
