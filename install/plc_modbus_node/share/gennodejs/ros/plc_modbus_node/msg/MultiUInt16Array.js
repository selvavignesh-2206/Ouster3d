...
class MultiUInt16Array {
  ...
  static serialize(obj, buffer, bufferOffset) {
    ...
    obj.arrays.forEach((val) => {
      bufferOffset = UInt16Array.serialize(val, buffer, bufferOffset);
    });
    return bufferOffset;
  }
  ...
  static getMessageSize(object) {
    ...
    object.arrays.forEach((val) => {
      length += UInt16Array.getMessageSize(val);
    });
    return length + 4;
  }
...
module.exports = MultiUInt16Array;
