...
//#line 291 "/opt/ros/noetic/lib/python3/dist-packages/dynamic_reconfigure/parameter_generator_catkin.py"
      Default.abstract_parameters.push_back(MLSConfig::AbstractParamDescriptionConstPtr(new MLSConfig::ParamDescription<int>("spatial_locator", "int", 0, "Set the spatial locator", "{'enum': [{'name': 'ANN', 'type': 'int', 'value': 0, 'srcline': 9, 'srcfile': '/home/msi/caato2_ws/src/siot/amcl/perception_pcl/pcl_ros/cfg/MLS.cfg', 'description': 'ANN', 'ctype': 'int', 'cconsttype': 'const int'}, {'name': 'FLANN', 'type': 'int', 'value': 1, 'srcline': 9, 'srcfile': '/home/msi/caato2_ws/src/siot/amcl/perception_pcl/pcl_ros/cfg/MLS.cfg', 'description': 'FLANN', 'ctype': 'int', 'cconsttype': 'const int'}, {'name': 'organized', 'type': 'int', 'value': 2, 'srcline': 9, 'srcfile': '/home/msi/caato2_ws/src/siot/amcl/perception_pcl/pcl_ros/cfg/MLS.cfg', 'description': 'Dense/organized data locator', 'ctype': 'int', 'cconsttype': 'const int'}], 'enum_description': 'Set the spatial locator'}", &MLSConfig::spatial_locator)));
//#line 291 "/opt/ros/noetic/lib/python3/dist-packages/dynamic_reconfigure/parameter_generator_catkin.py"
      __param_descriptions__.push_back(MLSConfig::AbstractParamDescriptionConstPtr(new MLSConfig::ParamDescription<int>("spatial_locator", "int", 0, "Set the spatial locator", "{'enum': [{'name': 'ANN', 'type': 'int', 'value': 0, 'srcline': 9, 'srcfile': '/home/msi/caato2_ws/src/siot/amcl/perception_pcl/pcl_ros/cfg/MLS.cfg', 'description': 'ANN', 'ctype': 'int', 'cconsttype': 'const int'}, {'name': 'FLANN', 'type': 'int', 'value': 1, 'srcline': 9, 'srcfile': '/home/msi/caato2_ws/src/siot/amcl/perception_pcl/pcl_ros/cfg/MLS.cfg', 'description': 'FLANN', 'ctype': 'int', 'cconsttype': 'const int'}, {'name': 'organized', 'type': 'int', 'value': 2, 'srcline': 9, 'srcfile': '/home/msi/caato2_ws/src/siot/amcl/perception_pcl/pcl_ros/cfg/MLS.cfg', 'description': 'Dense/organized data locator', 'ctype': 'int', 'cconsttype': 'const int'}], 'enum_description': 'Set the spatial locator'}", &MLSConfig::spatial_locator)));
//#line 291 "/opt/ros/noetic/lib/python3/dist-packages/dynamic_reconfigure/parameter_generator_catkin.py"
...
//#line 9 "/home/msi/caato2_ws/src/siot/amcl/perception_pcl/pcl_ros/cfg/MLS.cfg"
      const int MLS_ANN = 0;
//#line 9 "/home/msi/caato2_ws/src/siot/amcl/perception_pcl/pcl_ros/cfg/MLS.cfg"
