...
(cl:defmethod cl:initialize-instance :after ((m <Save_Wp-request>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'Save_Wp-request)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name atc_waypoints-srv:<Save_Wp-request> is deprecated: use atc_waypoints-srv:Save_Wp-request instead.")))

(cl:ensure-generic-function 'file_name-val :lambda-list '(m))
(cl:defmethod file_name-val ((m <Save_Wp-request>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader atc_waypoints-srv:file_name-val is deprecated.  Use atc_waypoints-srv:file_name instead.")
  (file_name m))
...
(cl:defmethod cl:initialize-instance :after ((m <Save_Wp-response>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'Save_Wp-response)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name atc_waypoints-srv:<Save_Wp-response> is deprecated: use atc_waypoints-srv:Save_Wp-response instead.")))
