...
(cl:in-package atc_waypoints-msg)
...
(cl:defclass <waypointArray> (roslisp-msg-protocol:ros-message)
  ((header
   ...
   (waypoints
    :reader waypoints
    :initarg :waypoints
    :type (cl:vector atc_waypoints-msg:waypoint_msg)
   :initform (cl:make-array 0 :element-type 'atc_waypoints-msg:waypoint_msg :initial-element (cl:make-instance 'atc_waypoints-msg:waypoint_msg)))
   (groups
    :reader groups
    :initarg :groups
    :type (cl:vector atc_waypoints-msg:waypoint_group)
   :initform (cl:make-array 0 :element-type 'atc_waypoints-msg:waypoint_group :initial-element (cl:make-instance 'atc_waypoints-msg:waypoint_group))))
)
...
(cl:defmethod cl:initialize-instance :after ((m <waypointArray>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'waypointArray)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name atc_waypoints-msg:<waypointArray> is deprecated: use atc_waypoints-msg:waypointArray instead.")))

(cl:ensure-generic-function 'header-val :lambda-list '(m))
(cl:defmethod header-val ((m <waypointArray>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader atc_waypoints-msg:header-val is deprecated.  Use atc_waypoints-msg:header instead.")
  (header m))

(cl:ensure-generic-function 'waypoints-val :lambda-list '(m))
(cl:defmethod waypoints-val ((m <waypointArray>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader atc_waypoints-msg:waypoints-val is deprecated.  Use atc_waypoints-msg:waypoints instead.")
  (waypoints m))

(cl:ensure-generic-function 'groups-val :lambda-list '(m))
(cl:defmethod groups-val ((m <waypointArray>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader atc_waypoints-msg:groups-val is deprecated.  Use atc_waypoints-msg:groups instead.")
  (groups m))
...
(cl:defmethod roslisp-msg-protocol:deserialize ((msg <waypointArray>) istream)
  ...
  (cl:let ((vals (cl:slot-value msg 'waypoints)))
    ...
    (cl:setf (cl:aref vals i) (cl:make-instance 'atc_waypoints-msg:waypoint_msg))
  ...
  (cl:let ((vals (cl:slot-value msg 'groups)))
    (cl:dotimes (i __ros_arr_len)
    (cl:setf (cl:aref vals i) (cl:make-instance 'atc_waypoints-msg:waypoint_group))
  (roslisp-msg-protocol:deserialize (cl:aref vals i) istream))))
  msg
)
...
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql '<waypointArray>)))
  ...
  (cl:format cl:nil "string header~%atc_waypoints/waypoint_msg[] waypoints~%atc_waypoints/waypoint_group[] groups~%~%================================================================================~%MSG: atc_waypoints/waypoint_msg~%string name~%geometry_msgs/Pose pose~%~%================================================================================~%MSG: geometry_msgs/Pose~%# A representation of pose in free space, composed of position and orientation. ~%Point position~%Quaternion orientation~%~%================================================================================~%MSG: geometry_msgs/Point~%# This contains the position of a point in free space~%float64 x~%float64 y~%float64 z~%~%================================================================================~%MSG: geometry_msgs/Quaternion~%# This represents an orientation in free space in quaternion form.~%~%float64 x~%float64 y~%float64 z~%float64 w~%~%================================================================================~%MSG: atc_waypoints/waypoint_group~%string name~%string[] wp_list~%~%~%"))
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql 'waypointArray)))
  "Returns full string definition for message of type 'waypointArray"
  (cl:format cl:nil "string header~%atc_waypoints/waypoint_msg[] waypoints~%atc_waypoints/waypoint_group[] groups~%~%================================================================================~%MSG: atc_waypoints/waypoint_msg~%string name~%geometry_msgs/Pose pose~%~%================================================================================~%MSG: geometry_msgs/Pose~%# A representation of pose in free space, composed of position and orientation. ~%Point position~%Quaternion orientation~%~%================================================================================~%MSG: geometry_msgs/Point~%# This contains the position of a point in free space~%float64 x~%float64 y~%float64 z~%~%================================================================================~%MSG: geometry_msgs/Quaternion~%# This represents an orientation in free space in quaternion form.~%~%float64 x~%float64 y~%float64 z~%float64 w~%~%================================================================================~%MSG: atc_waypoints/waypoint_group~%string name~%string[] wp_list~%~%~%"))
