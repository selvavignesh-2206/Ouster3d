...
(cl:defmethod cl:initialize-instance :after ((m <waypoint_group>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'waypoint_group)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name atc_waypoints-msg:<waypoint_group> is deprecated: use atc_waypoints-msg:waypoint_group instead.")))

(cl:ensure-generic-function 'name-val :lambda-list '(m))
(cl:defmethod name-val ((m <waypoint_group>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader atc_waypoints-msg:name-val is deprecated.  Use atc_waypoints-msg:name instead.")
  (name m))

(cl:ensure-generic-function 'wp_list-val :lambda-list '(m))
(cl:defmethod wp_list-val ((m <waypoint_group>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader atc_waypoints-msg:wp_list-val is deprecated.  Use atc_waypoints-msg:wp_list instead.")
  (wp_list m))
