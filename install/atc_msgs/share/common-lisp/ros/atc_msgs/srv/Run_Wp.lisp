...
(cl:defmethod cl:initialize-instance :after ((m <Run_Wp-request>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'Run_Wp-request)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name atc_msgs-srv:<Run_Wp-request> is deprecated: use atc_msgs-srv:Run_Wp-request instead.")))
...
(cl:defmethod gr_name-val ((m <Run_Wp-request>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader atc_msgs-srv:gr_name-val is deprecated.  Use atc_msgs-srv:gr_name instead.")
  (gr_name m))

(cl:ensure-generic-function 'loop-val :lambda-list '(m))
(cl:defmethod loop-val ((m <Run_Wp-request>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader atc_msgs-srv:loop-val is deprecated.  Use atc_msgs-srv:loop instead.")
  (loop m))

(cl:ensure-generic-function 'index-val :lambda-list '(m))
(cl:defmethod index-val ((m <Run_Wp-request>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader atc_msgs-srv:index-val is deprecated.  Use atc_msgs-srv:index instead.")
  (index m))
...
(cl:defmethod cl:initialize-instance :after ((m <Run_Wp-response>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'Run_Wp-response)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name atc_msgs-srv:<Run_Wp-response> is deprecated: use atc_msgs-srv:Run_Wp-response instead.")))
