...
(cl:defmethod cl:initialize-instance :after ((m <Groups_Wp-request>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'Groups_Wp-request)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name atc_msgs-srv:<Groups_Wp-request> is deprecated: use atc_msgs-srv:Groups_Wp-request instead.")))
...
(cl:defmethod cl:initialize-instance :after ((m <Groups_Wp-response>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'Groups_Wp-response)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name atc_msgs-srv:<Groups_Wp-response> is deprecated: use atc_msgs-srv:Groups_Wp-response instead.")))
