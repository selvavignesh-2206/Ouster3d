...
(cl:defmethod cl:initialize-instance :after ((m <Load_Wp-request>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'Load_Wp-request)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name atc_msgs-srv:<Load_Wp-request> is deprecated: use atc_msgs-srv:Load_Wp-request instead.")))
...
(cl:defmethod cl:initialize-instance :after ((m <Load_Wp-response>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'Load_Wp-response)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name atc_msgs-srv:<Load_Wp-response> is deprecated: use atc_msgs-srv:Load_Wp-response instead.")))
