...
#ifndef OUSTER_GAZEBO_SIMULATION_DEPRECATED_HH
# define OUSTER_GAZEBO_SIMULATION_DEPRECATED_HH
...
//  void foo () OUSTER_GAZEBO_SIMULATION_DEPRECATED;
//
// Tagging a type as deprecated:
//  class Foo {};
//  typedef Foo Bar OUSTER_GAZEBO_SIMULATION_DEPRECATED;
//
// Tagging a variable as deprecated:
//  int a OUSTER_GAZEBO_SIMULATION_DEPRECATED = 0;
//
...
#  define OUSTER_GAZEBO_SIMULATION_DEPRECATED __attribute__ ((deprecated))
# else
#  if defined(_MSC_VER) && !defined(__INTEL_COMPILER)
#   define OUSTER_GAZEBO_SIMULATION_DEPRECATED __declspec (deprecated)
#  else
// If the compiler is not recognized, drop the feature.
#   define OUSTER_GAZEBO_SIMULATION_DEPRECATED /* nothing */
#  endif // __MSVC__
# endif // __GNUC__

#endif //! OUSTER_GAZEBO_SIMULATION_DEPRECATED_HH
