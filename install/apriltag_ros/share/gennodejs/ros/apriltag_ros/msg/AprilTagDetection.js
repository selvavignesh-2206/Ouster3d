...
class AprilTagDetection {
  constructor(initObj={}) {
    if (initObj === null) {
      ...
      if (initObj.hasOwnProperty('tagArea')) {
        this.tagArea = initObj.tagArea
      }
      else {
        this.tagArea = 0.0;
      }
  ...
  static serialize(obj, buffer, bufferOffset) {
    ...
    bufferOffset = _serializer.float64(obj.pixelPosRight, buffer, bufferOffset);
    // Serialize message field [pixelPosDown]
    bufferOffset = _serializer.float64(obj.pixelPosDown, buffer, bufferOffset);
    // Serialize message field [tagArea]
    bufferOffset = _serializer.float64(obj.tagArea, buffer, bufferOffset);
    return bufferOffset;
  }
  ...
  static deserialize(buffer, bufferOffset=[0]) {
    ...
    data.pixelPosRight = _deserializer.float64(buffer, bufferOffset);
    // Deserialize message field [pixelPosDown]
    data.pixelPosDown = _deserializer.float64(buffer, bufferOffset);
    // Deserialize message field [tagArea]
    data.tagArea = _deserializer.float64(buffer, bufferOffset);
    return data;
  }
  ...
  static md5sum() {
    ...
    return '3d65b1a354327ff08aa51847b4a25220';
  }
  ...
  static Resolve(msg) {
    ...
    if (msg.tagArea !== undefined) {
      resolved.tagArea = msg.tagArea;
    }
    else {
      resolved.tagArea = 0.0
    }
